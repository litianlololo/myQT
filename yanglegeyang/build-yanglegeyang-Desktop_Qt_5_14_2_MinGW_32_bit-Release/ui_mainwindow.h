...
public:
    ...
    void setupUi(QWidget *MainWindow)
    {
        ...
        label->setGeometry(QRect(0, 10, 781, 471));
        ...
        timelabel->setGeometry(QRect(630, 40, 61, 41));
        timelabel->setTextFormat(Qt::AutoText);
        timeshow = new QLabel(MainWindow);
        timeshow->setObjectName(QString::fromUtf8("timeshow"));
        timeshow->setGeometry(QRect(680, 50, 81, 18));
        RankingLabel = new QLabel(MainWindow);
        RankingLabel->setObjectName(QString::fromUtf8("RankingLabel"));
        RankingLabel->setGeometry(QRect(30, 270, 161, 161));
        label->raise();
        beginGameBtn->raise();
        deleteWidget->raise();
    ...
    void retranslateUi(QWidget *MainWindow)
    {
        ...
        timelabel->setText(QCoreApplication::translate("MainWindow", "\350\200\227\346\227\266\357\274\232", nullptr));
        timeshow->setText(QString());
        RankingLabel->setText(QString());
    } // retranslateUi
